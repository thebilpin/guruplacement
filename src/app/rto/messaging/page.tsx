...
const conversations = [
  { name: 'John Smith (Supervisor)', lastMessage: 'The timesheet looks good, approved.', time: '10m', avatar: 'https://picsum.photos/seed/supervisor/100/100' },
  { name: 'All Students (Announcement)', lastMessage: 'Reminder: Placements for Semester 2...', time: '1h', avatar: null, isGroup: true },
  { name: 'Emily White (Provider)', lastMessage: 'Yes, we have capacity for two more students.', time: '3h', avatar: 'https://picsum.photos/seed/provider1/100/100' },
  { name: 'Ben Carter (Student)', lastMessage: 'I have a question about my logbook.', time: 'yesterday', avatar: 'https://picsum.photos/seed/student2/100/100' },
];

const messages = [
    { sender: 'John Smith', text: 'The timesheet looks good, approved.', time: '10:30 AM', isOwn: false },
    { sender: 'You', text: 'Thanks, John! Let me know if there\'s anything else.', time: '10:32 AM', isOwn: true },
];

export default function RTOMessagingPage() {
                  ...
                  {messages.map((msg, index) => (
                    <div key={index} className={`flex items-end gap-3 ${msg.isOwn ? 'justify-end' : ''}`}>
                      ...
                      <div className={`max-w-md p-3 rounded-lg ${msg.isOwn ? 'bg-primary text-primary-foreground' : 'bg-white shadow-sm'}`}>
                       ...
                       {msg.isOwn && (
                        <Avatar className="h-8 w-8">
                             <AvatarImage src="https://picsum.photos/seed/rt-admin/100/100" />
